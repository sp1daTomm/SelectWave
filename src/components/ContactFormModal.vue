...
<template>
  <fwb-modal v-if="props.isShowModal" @close="props.closeModal" size="7xl">
        ...
        <div class="flex flex-col items-center gap-12 md:flex-row-reverse md:justify-between md:px-20">
          ...
          <section class="flex flex-col gap-6 md:w-1/2">
            ...
            <form class="flex flex-col gap-6" @submit="onSubmit">
                  ...
                  <div v-if="item.type === 'checkbox'" class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-wrap gap-4">
                      <div v-for="list in item.list" :key="list">
                        <input :type="item.type" :id="list.value" :value="list.value" v-model="quests" v-bind="questsAttrs" class="mr-3 text-primary focus:ring-primary" :disabled="isLoading" />
              ...
              <div>
                <input type="checkbox" id="agree" v-model="agree" v-bind="agreeAttrs" class="text-primary focus:ring-primary" required :disabled="isLoading" />
              ...
              <input type="submit" value="送出" class="px-6 py-3 text-white transition duration-300 rounded-full bg-primary-dark hover:bg-primary hover:cursor-pointer" :disabled="isLoading" />
            </form>
          </section>
        </div>
      </template>
